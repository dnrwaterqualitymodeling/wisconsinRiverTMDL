...
\caption[Agricultural land cover classes represented within SWAT]{The agricultural land cover classes represented within SWAT are shown here with the class of land use and land management. The rotation codes are Cg=corn grain, Cs=corn silage, So=soybean, Po=potato, Vg=vegetable, A=Alfalfa, O/A=oats/alfalfa. Tons are English tons. Note that the SWAT Landuse is a code used by SWAT and is a placeholder for unique agricultural practices and are not truly representative of the landcover and is only included here for reference.} 
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline 
...
%%%%% repeating head
	...
	\hline 
	\multicolumn{3}{r}{\textit{Continued on next page}} \endfoot
...
%%% 23-Mar-2015 Rotations for PNUT and FPEA switched.
