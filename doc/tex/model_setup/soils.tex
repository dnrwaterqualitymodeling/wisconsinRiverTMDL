...
Several of the soil property fields of the SSURGO dataset did not seem to be
populated or commonly had no data values, these properties were not used in the
...
Not every mapunit was included in the clustering procedure. Those mapunits that
