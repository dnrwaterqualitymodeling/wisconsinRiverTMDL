...
components, and horizons \ref{fig:ssurgo_schematic}. Horizons are the fundamental unit of soil in SSURGO, and are
...
A total of 35 soil classes were distilled from this process. The properties of each are summarized in \ref{table:soil_prop} and the number of mapunits in each cluster can be found in \input{./tab/soil_clusters_table.tex}.

The hydrologic soil groups, the  \ref{fig:soil_boxplots}.
