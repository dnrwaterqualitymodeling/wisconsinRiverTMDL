...
units were aggregated,\footnote{\url{https://github.com/dnrwaterqualitymodeling/wisconsinRiverTMDL/blob/master/soils/step1_aggregate_gSSURGO.R} } 
and second, map units were aggregated based on
...
given by SSURGO as soil organic matter. The organic matter value (percent) given in SSURGO
...
necessarily on SWAT relevant properties. We prioritized the most relevant soils
information to SWAT as the hydrology data, specifically the HSG, which has a large impact on the curve number calculation. With this
...
The map units within each of these clusters were averaged to create
...
Each of the 1,603 map units had data regarding the soil property values at each
...
phosphorus concentrations were aggregated per county by the soil laboratory for
