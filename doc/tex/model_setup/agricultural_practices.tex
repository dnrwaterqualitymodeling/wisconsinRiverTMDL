...
\subsubsection{Starter Fertilizer}

The starter fertilizer applications in SWAT were changed from 0.22 to 0.17 $tons \cdot ha^{-1} \cdot yr^{-1}$. This was done in following the suggestions from a panel of WDNR staff, faculty from the University of Wisconsin, private agronomists, manure haulers, and crop consultants.
