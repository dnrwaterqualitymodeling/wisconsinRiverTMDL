...
# CHANGE THESE ###########
yldCalib <- function(crop, scenario = 'defaultParameters', unit = 'metric', projectDir = 'H:/WRB', basinWide = F){
    
    #Parameters
#     crop <-'soybeans''haylage'
#     scenario <- 'twoCutAlfalfa'#'defaultParameters'scenario = 'Default'
#     unit <- 'metric'
#     projectDir <- 'H:/WRB'
    ...
    # Raw NASS data
    obsDataFile = "T:/Projects/Wisconsin_River/code/validation/upDated_NASSstats_30092014.csv"
...
yldCalib('corn_grain', scenario = 'ThreeCut_later',basinWide = T)
#yldCalib('haylage', scenario = 'ThreeCut_later', basinWide = T)
yldCalib('corn_silage', scenario = 'ThreeCut_later',basinWide = T)
yldCalib('soybeans', scenario = 'ThreeCut_later',basinWide = T)