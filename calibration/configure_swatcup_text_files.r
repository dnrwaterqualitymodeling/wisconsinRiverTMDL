...
projectDir = "D:/WRB_extra.Sufi2.SwatCup"
simCount = 768
subbasinCount = 337
startYr = 2002
endYr = 2013
...
#parameterization = rbind(
#	c("r__CANMX.hru________109-136,160-169,209,218-226,270-273,277-287,294-295,298-300,309,315-320,334-337",-0.5,0.5),
#	c("r__CANMX.hru________30,34,36,38-39,45-47,52-53,59-108,139-159,190-195,197-208,210-217,234,242,244-245,247-269,275-276,288-293,296-297,302-308,311,313-314,321-333",-0.5,0.5),
#	c("r__CANMX.hru________1-29,31-33,35,37,40-44,48-51,54-58,137-138,170-189,196,227-233,235-241,243,246,274,301,310,312",-0.5,0.5),
